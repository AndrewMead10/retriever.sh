...
- Docs download refresh (Feb 7, 2026): `/docs` downloadable `retriever-claude-skill.md` now matches live project-scoped API routes (`/api/rag/projects/{project_id}/...` + project API key auth) and uses fixed `https://retriever.sh` examples (no base-url env var or deployment section).
